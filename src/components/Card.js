...
function CardEl({src,text,header,post_hint,author,thumbnail}){
    ...
    return(
        ...
        <div className='  d-flex  justify-content-center  col-lg-12 m-1' style={{height:'max-content',position:'relative'}}>
            <div className='img-container border rounded 'style={{height:'80px',width:'80px',position:'sticky',top:'100px',margin:'10px',overflow:'hidden'}}>
